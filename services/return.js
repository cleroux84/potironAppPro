...
const createReturnOrder = async (accessTokenWarehouse, orderId, returnAll, productSku) => {
    ...
    // Crée les articles d'attente de retour en fonction de `returnAll`
    ...
    // Options de requête pour créer le retour
    ...
    try {
        ...
        // Vérification si la requête est réussie avant de retourner les données
        if (response.ok) {
